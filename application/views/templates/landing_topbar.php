    ...
    <header class="header mb-5">
      ...
      *** TOPBAR ***
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg text-center text-lg-right">
              <ul class="menu list-inline align-left">
                <li class="list-inline-item"><a href="#" data-toggle="modal" data-target="#login-modal">Login</a></li>
                <li class="list-inline-item"><a href="<?= base_url() . "home/register"; ?>">Register</a></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <p class="text-center text-muted"><a href="<?= base_url() . "home/register"; ?>"><strong>Register now</strong></a></p>
              </div>
            </div>
          </div>
        </div>
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="#" class="navbar-brand home"><img src="<?= base_url() ?>assets/dist/img/home/ybm.jpg" width="120px" height="80px" alt="Obaju logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" class="d-inline-block d-md-none"></a>
          <div class="navbar-buttons">
            <button type="button" data-toggle="collapse" data-target="#navigation" class="btn btn-outline-secondary navbar-toggler"><span class="sr-only">Toggle navigation</span><i class="fa fa-align-justify"></i></button>
            <button type="button" data-toggle="collapse" data-target="#search" class="btn btn-outline-secondary navbar-toggler"><span class="sr-only">Toggle search</span><i class="fa fa-search"></i></button><a href="basket.htmlasd" class="btn btn-outline-secondary navbar-toggler"><i class="fa fa-shopping-cart"></i></a>
          </div>
